    ...
    <div id="proyectos" className="container md:w-[80%] mx-auto p-4">
        ...
        <div className=" md:grid md:grid-cols-2 max-w-[100rem] md:gap-16 mt-10 mx-auto ">
              ...
              <div className="col-start-2  col-span-2" >
                <a className="text-gray-700 hover:text-indigo-600 underline font-bold text-3xl" target="_blank" href="https://lordkevinrblogdecafeproject.netlify.app/">Proyecto Blog de Café</a>
              ...
              <div className="col-start-2 col-span-2" >
                <a className="text-gray-700 hover:text-indigo-600 underline font-bold text-3xl" target="_blank" href="https://lordkevinrmusicalfestivalproject.netlify.app/">Proyecto Rock & EDM Festival</a>
              ...
              <div className="col-start-2 col-span-2" >
                <a className="text-gray-700 hover:text-indigo-600 underline font-bold text-3xl" target="_blank" href="https://lordkevinrfrontstoreproject.netlify.app/">Proyecto FrontEnd Store</a>
                <ul className="mt-5 mb-24 md:mb-0 text-gray-700 font-bold text-xl">
                  <li>Tecnologias Usadas:</li>
                  <li>- Responsive Desing</li>
                  <li>- SASS</li>

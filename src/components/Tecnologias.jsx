const Tecnologias = () => {
  return (
    <div id="tecnologias" className="bg-sky-500 pb-16 md:pb-0 md:h-screen">
        <h1 className="text-slate-100 font-bold text-center text-5xl pt-16">Tecnologias</h1>

        <div className="md:grid max-w-[70rem] text-gray-700 md:grid-cols-2 w-[80%] rounded-lg mx-auto mt-16 text-center h-3/5 md:h-1/2 bg-slate-100 gap-4 p-4">
